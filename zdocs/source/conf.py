...
latex_documents = [
    (master_doc, "grpcErr.text", "grpcErr Documentation", "Billy Peake", "manual")
]
...
man_pages = [(master_doc, "grpcErr", "grpcErr Documentation", 1)]
